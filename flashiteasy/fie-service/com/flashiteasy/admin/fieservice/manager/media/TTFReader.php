...
class TTFReader extends BaseManager {
	...
	// V 1.1 - unicode characters/null bytes inside fontparameters handling
		...
		$transfer->contentArray = array('fontfamily'=>$fontfamily,
											'fontsubfamily'=>$fontsubfamily,
											'fullfontname'=>$fullfontname,
											'copyright'=>$copyright);
		$transfer->message = $this->error;
